        ...
        <form action="proses-edit.php" method="POST">
            ...
            <fieldset>
                ...
                <p>
                    ...
                    <textarea name="nomor"><?php echo $d['nomor'] ?></textarea>
                </p>
                <p>
                ...
                <p>
                    <label for="kodepost">Kodepos: </label>
                    <input type="text" name="kodepost" placeholder="kodepost" value="<?php echo $d['kodepost'] ?>" />
                </p>
                <p>
